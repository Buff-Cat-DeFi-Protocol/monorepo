...
export const Footer: React.FC = () => {
  ...
  return (
    <>
      {pathname == "/" ? (
        <footer className="bg-transparent mb-6 ms-6 me-6 border-t border-l border-r border-[10px] border-gray-800">
        ...
        <footer className="bg-transparent flex justify-between mb-6 ms-14 me-14">
          <div className="text-custom-muted-text">© 2025 Buffcat</div>
